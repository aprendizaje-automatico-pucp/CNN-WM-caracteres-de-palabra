...
def lang_raw_data(data_path=None, lang=None):
  """Load language raw data from data directory "data_path".
  ...
  Returns:
    ...
    where each of the data objects can be passed to LangIterator.
  """
...
def lang_producer(raw_data, batch_size, num_steps, name=None):
  """Iterate on the raw language data.
  ...
  """
  with tf.name_scope(name, "LangProducer", [raw_data, batch_size, num_steps]):
